...
function LaserDentalTreatmentPage() {
  return (
    <>
      <Helmet>
        <title>Laser Dental Treatment - SS Dental Care Davangere</title>
        <meta name="description" content="Minimally invasive laser dentistry in Davangere. Advanced laser treatments for gums, cavities, and soft tissue procedures at SS Dental Care." />
      </Helmet>
        ...
        <section className="py-20 bg-gradient-to-br from-primary/5 via-background to-accent/5">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl mx-auto text-center">
              <h1 className="mb-6">Laser Dental Treatment</h1>
              <p className="text-xl text-muted-foreground leading-relaxed">Minimally invasive procedures using advanced laser technology</p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto">
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Laser dentistry uses focused light energy to perform precise dental procedures with minimal discomfort and faster healing. We use dental lasers for a variety of treatments including gum reshaping, cavity treatment, teeth whitening, and soft tissue procedures.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  Laser treatments are often less invasive than traditional methods, reducing the need for anesthesia and sutures while promoting faster recovery and better outcomes.
                </p>
              </motion.div>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mt-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {[
                    ...
                    { step: '2', title: 'Laser Treatment', desc: 'Precise laser application' },
                    { step: '3', title: 'Recovery', desc: 'Quick healing with minimal discomfort' },
                  ].map((item) => (
